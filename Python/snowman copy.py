...
class TheeSnowMen(object):
  def __init__(self):
    ...
    s1 = Snowman(50, (0, 0), multi_color=False, arm_color="black", eye_size=5, eye_color="black", mouth_size=1, mouth_color="black", hat_color="black", botton_size=7, bottom_color_list=["grey"])
    penup()
    home()
    ...
    penup()
    home()
    s4 = Snowman(30, (200, 0), multi_color=True, arm_color="black", eye_size=10, eye_color="blue", mouth_size=3, mouth_color="red", hat_color="purple", botton_size=20, bottom_color_list=["blue", "red", "green", "gold"])
    mainloop()
