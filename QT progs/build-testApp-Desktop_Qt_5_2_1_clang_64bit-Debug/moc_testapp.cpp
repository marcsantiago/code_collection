...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_testapp_t, stringdata) + ofs \
...
const QMetaObject testapp::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_testapp.data,
      qt_meta_data_testapp,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_testapp.stringdata))
