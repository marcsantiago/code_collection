...
#
# ActiveState ActiveTcl 8.6.1.1.297588 OS X/Leopard/i386-x86_64, Sat Oct 26 19:58:59 PDT 2013
#
...
namespace eval ::activestate {
	...
	product       {ActiveTcl}
	release       {8.6.1.1}
	tcl,revision  {d7d7d0857dd5d4a851608e7ceeed0b7ccd50187f}
	tk,revision   {bde04c8808a8f60a44ca1917575cf3d325cae3d2}
	maturity      {final}
	arch          {macosx10.5-ix86}
	buildtime,sec {1382842739}
	buildtime,fmt {Sat Oct 26 19:58:59 PDT 2013}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.1.1.297588 OS X/Leopard/i386-x86_64 @ Sat Oct 26 19:58:59 PDT 2013 d7d7d0857dd5d4a851608e7ceeed0b7ccd50187f / normal}
    }
}

package provide {ActiveTcl} {8.6.1.1.297588}
